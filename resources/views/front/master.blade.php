...
<html lang="en">
<head>
    <title>MobiXpress &mdash; Website by Asad</title>
    <meta charset="utf-8">
...
<div class="site-wrap">
    ...
    <header class="site-navbar navbar-collapse py-4 bg-white js-sticky-header site-navbar-target" role="banner">

        <div class="container">
            <div class="row align-items-center">

                <div class="col-6 col-xl-2">
                    <h1 class="mb-0 site-logo"><a href="{{url('/')}}" class="text-black mb-0">MobiXpress<span class="text-primary">.</span> </a></h1>
                </div>
                <div class="col-12 col-md-10 d-none d-xl-block">
                    <nav class="site-navigation position-relative text-right" role="navigation">
                        ...
                        <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                            ...
                            <li><a href="{{url('/shop')}}" class="nav-link">Products</a></li>
                            ...
                            <li> <form class="form-inline my-0 my-lg-0">
